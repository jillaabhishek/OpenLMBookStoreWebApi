...
namespace OpenLMBookStore.Migrations
{
    ...
    [Migration("20210829120833_AddingAddressPropertyInOrderEntity")]
    partial class AddingAddressPropertyInOrderEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenLMBookStore.Entities.Book", b =>
                {
                    ...
                    b.Property<bool>("IsBookBestSeller")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("OpenLMBookStore.Entities.Publisher", b =>
                {
                    b.Property<string>("PublisherId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("OpenLMBookStore.Entities.Book", b =>
                {
                    b.HasOne("OpenLMBookStore.Entities.Author", "Author")
                        .WithMany("Books")
                        .HasForeignKey("AuthorId");

                    b.HasOne("OpenLMBookStore.Entities.Publisher", "Publisher")
                        .WithMany("Books")
